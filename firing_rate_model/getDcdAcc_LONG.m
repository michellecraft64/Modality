...
% >> save dFitMeans Am_O Am_R Ap_* InputCurrent_* Tmev sumSpks0 alphMax* w_Parr dt sc aspPv Ntr


save_flag=0; %if this is =1, WILL OVERWRITE EXISTING dJustDeAcc.mat
...
nuOint=sum(Am_O,2)*dt/(1000*Tmev(end));
nuRint=sum(Am_R,2)*dt/(1000*Tmev(end));
