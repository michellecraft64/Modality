...
%calc std spread
stSpread_ND=abs(std(sumSpk_Orth_ND,0,2)-std(sumSpk_Ret_ND,0,2));
stSpread_Bic=abs(std(sumSpk_Orth_Bic,0,2)-std(sumSpk_Ret_Bic,0,2));
stSpread_Mus=abs(std(sumSpk_Orth_Mus,0,2)-std(sumSpk_Ret_Mus,0,2));
